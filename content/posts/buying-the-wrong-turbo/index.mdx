...
- Variable Valve Timing (VVT) on BAM: this was introduced purely for emissions reasons.
...
- Exhaust Gas Temperature Sensor on BAM: this is used to protect components such as the
