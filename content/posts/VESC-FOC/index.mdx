...
on the topic: [vedder video](https://www.youtube.com/watch?v=bYYNbxPXNEU&t=343s).

### Hall effect sensors 🔬

Hall effect sensors are used for position control. These sensors are particularly important for estimating
position when the motor is stationary. I think the VESC that I'm using uses Back EMF sensing at high
speeds anyways because it's more accurate. However, hall sensors work the same regardless of speed. When
