...
>
  ...
  <Timeline>
    ...
    <TimelineItem title="Turbo Replacement" status="Completed" type="normal" date="14.11.2020">
      ...
      <img src={NewTurboImage} style={{ maxWidth: 400, marginTop: 10 }} />
    </TimelineItem>
    ...
    <TimelineItem title="Exhaust Reassembly" status="Completed" type="normal" date="14.11.2020">
      I had some difficulty with the cheap chinese downpipe and midpipe as expected. The midpipe was slightly too small to
    ...
    <TimelineItem title="Engine First Start Preparation" status="In progress" type="end">
      The cooling system and power steering system need to be reinstalled, a once over of all fittings
      and hoses must be done and fluids added before the first start of the engine again.
    </TimelineItem>
  </Timeline>
