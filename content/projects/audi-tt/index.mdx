...
>
  ...
  <Timeline>
    ...
    <TimelineItem title="Cylinder Head Cover Gasket" status="In progress" type="normal">
    ...
    <TimelineItem title="Exhaust Reassembly" status="Not started" type="normal">
      The new exhaust downpipe can be fitted when the engine is reinstalled.
    </TimelineItem>
    <TimelineItem title="Front Axle Reassembly" status="Not started" type="end">
