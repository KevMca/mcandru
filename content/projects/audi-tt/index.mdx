...
<br />
<Timeline title="Front Axle Disassembly" status="Completed" date="11.04.2020" type="normal">
...
<Timeline title="Exhaust System Disassembly" status="Completed" date="18.04.2020" type="normal">
...
<Timeline title="Engine Removal" status="Completed" date="18.07.2020" type="normal">
...
<Timeline title="Turbo Removal" status="Completed" date="27.07.2020" type="normal">
...
<Timeline title="Subframe and Control Arm Restoration" status="Completed" date="09.09.2020" type="normal">
...
<Timeline title="Turbo Replacement" status="In progress" type="normal">
  A rebuilt OEM Borg-Warner turbo has been purchased and will be fitted once it arrives.
</Timeline>
<Timeline title="Cylinder Head Cover Gasket" status="In progress" type="normal">
...
<Timeline title="Engine Reinstallation" status="Not started" type="normal">
  After the turbo and cylinder head cover gasket have been replaced, the engine can be refitted.
</Timeline>
<Timeline title="Exhaust Reassembly" status="Not started" type="normal">
  The new exhaust downpipe can be fitted when the engine is reinstalled.
</Timeline>
<Timeline title="Front Axle Reassembly" status="Not started" type="end">
