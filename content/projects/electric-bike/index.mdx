...
>
  ...
  **V3:** *Same as V2 with better motor mount and modular battery*
  ...
  <Timeline>
    ...
    <TimelineItem title="Buy and install casette" status="Completed" date="02.10.2020" type="normal">
    ...
    <TimelineItem title="Install hall sensors and setup FOC" status="Completed" date="09.10.2020" type="normal"
        posts={["motor-control", "vesc-foc"]}>
    ...
    <TimelineItem title="Add BMS to the battery" status="Completed" date="03.11.2020" type="normal">
      I bought a BMS for the battery that I have a while ago. However, the BMS was faulty. I have a new one that
      I have been meaning to install for a while. It's finally installed now 😊
    </TimelineItem>
    <TimelineItem title="Install battery-run lights" status="Completed" date="06.12.2020" type="normal" type="end"
        posts={["bike-lights"]}>
