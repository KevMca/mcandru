  ...
  **V3:** *Same as V2 with better motor mount and modular battery*
  ...
  <Timeline>
    <TimelineItem title="Buy a new hub motor" status="Completed" date="11.8.2020" type="normal">
      ...
      This link might be broken: <a href="https://www.aliexpress.com/item/32988879954.html">https://www.aliexpress.com/item/32988879954.html</a>
    </TimelineItem>
    <TimelineItem title="Test hub motor" status="Completed" date="15.8.2020" type="normal">
      All of the electronics are setup, so it's a matter of just plugging everything and seeing how well it works.
    </TimelineItem>
    <TimelineItem title="Balance the hub motor" status="In progress" type="normal">
      The hub motor needs to be balanced to run smooth. This can be done with some tape and coins.
    </TimelineItem>
    ...
    <TimelineItem title="Build the wheel" status="Not started" type="normal">
      A new wheel needs to be built from the scavenged spokes and rims of my old wheels.
    </TimelineItem>
    <TimelineItem title="Build the wooden panels" status="Not started" type="normal">
