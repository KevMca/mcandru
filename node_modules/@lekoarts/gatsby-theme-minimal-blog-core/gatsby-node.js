...
exports.onCreateNode = ({ node, actions, getNode, createNodeId, createContentDigest }, themeOptions) => {
  ...
  const { postsPath, pagesPath, projectsPath } = withDefaults(themeOptions)
...
const showProjectsTemplate = require.resolve(`./src/templates/show-projects-query.tsx`)
...
exports.createPages = async ({ actions, graphql, reporter }, themeOptions) => {
  ...
  const { basePath, blogPath, tagsPath, formatString, showProjectsPath } = withDefaults(themeOptions)
  ...
  createPage({
    path: `/${basePath}/${showProjectsPath}`.replace(/\/\/+/g, `/`),
    component: showProjectsTemplate,
  })
